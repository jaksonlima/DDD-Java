...
import com.domain.driver.designer.application.genre.create.CreateGenreOutput;
...
import com.domain.driver.designer.application.genre.update.UpdateGenreOutput;
...
public final class GenreAPITest {
    ...
    public void givenAValidId_whenCallsGetGenreById_shouldReturnGenre() throws Exception {
        ...
        when(getGenreByIdUseCase.execute(any()))
                .thenReturn(GetGenreOutput.from(aGenre));
