...
import com.domain.driver.designer.infrastructure.api.VideoAPI;
import com.domain.driver.designer.infrastructure.utils.HashingUtils;
...
import com.domain.driver.designer.infrastructure.video.models.VideoListResponse;
import com.domain.driver.designer.infrastructure.video.models.VideoResponse;
import com.domain.driver.designer.infrastructure.video.presenters.VideoApiPresenter;
...
public class VideoController implements VideoAPI {
    ...
    public ResponseEntity<?> uploadMediaByType(final String id, final String type, final MultipartFile media) {
        final var aType = VideoMediaType.of(type)
                .orElseThrow(() -> NotificationException.with(new Errors("Invalid %s for VideoMediaType".formatted(type))));
